...
class NotebookPage():
    ...
    def start_page(nbPage,startHelp = False):
        ...
        self.lightButton = ttk.Radiobutton(self.themeDecider,text = "Light",image = lightModeIcon,compound="top",textvariable=self.theme,value=False)
        self.lightButton.pack(side="left")
        self.darkButton = ttk.Radiobutton(self.themeDecider,text = "Dark",image = darkModeIcon,compound="top",textvariable=self.theme,value=True)
