...
:@EndCatch
g++ -o %CD%/build/sdlWrapper.dll %CD%/sdlWrapper.cpp -I%CD%/SDL2 -shared -W -g -fPIC -Wall -Wpedantic
echo Engine built
exit
:runPython
%@try%
...
:@Catch
    echo Already in directory, Compiling
:@EndCatch
g++ -o %CD%/build/sdlTest.exe %CD%/cppTester.cpp -I%CD%/SDL2 -shared -W -g -fPIC -Wall -Wpedantic
echo Engine built
exit